...
sudo python ~/wax-iss/wax/melt_client.py start_log_preview_exp $label,"Fluid","$rpm","$setpoint" # Lights, camera, data log
sleep 3
...
sudo python ~/wax-iss/wax/melt_client.py set_motor_mode_st_time_based "$T13","$T2" # Mode 2: St-curve time-based
sleep 1
